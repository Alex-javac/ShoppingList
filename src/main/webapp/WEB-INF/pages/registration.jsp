...
<form id="regForm" action="check-user" method="post">
<%--<spring:form method="post" modelAttribute="userJSP" action="check-user">--%>
    ...
    <div class="tab">Nick:
        <p><input placeholder="Nick Name..." oninput="this.className = ''" name="nickName"></p>
    </div>
    <div class="tab">Login Info:
        <p><input placeholder="Login..." oninput="this.className = ''" name="login"></p>
